      ...
      setTimeout(() => {
        ...
        setMessages((prevMessages) =>
          prevMessages
            ...
            .concat({ author: "Bot", text: response })
        );
    ...
    if (allCommands.hasOwnProperty(command)) {
      ...
      return (
        <>
          <p>Hello.</p>
          <p>
            I am Frenify Bot. After purchasing the template, you can delete me
            easily. I understand some commands. You just select one of the
            commands and write here.
          </p>
          <p>Here is the list of commands:</p>
          <ul>
            <li>
              <frenify_main>/welcome</frenify_main> - welcome message
            </li>
            <li>
              <frenify_main>/about</frenify_main> - some information about the
              Frenify team
            </li>
            <li>
              <frenify_main>/website</frenify_main> - go to our official website
            </li>
            <li>
              <frenify_main>/free</frenify_main> - get PSD files of premium
              themes for free
            </li>
            <li>
              <frenify_main>/doc</frenify_main> - visit online documentation for
              TechWave HTML template
            </li>
            <li>
              <frenify_main>/support</frenify_main> - if you have any questions
              regarding TechWave HTML template feel free and contact us by this
              command
            </li>
            <li>
              <frenify_main>/purchase</frenify_main> - open the template
              description page on themeforest to purchase it
            </li>
            <li>
              <frenify_main>/youtube</frenify_main> - visit our youtube channel
              with video guides on our themes and templates
            </li>
            <li>
              <frenify_main>/pass</frenify_main> - if you want to get strong
              password I can generate it for you, write{" "}
              <frenify_main>/pass 20</frenify_main> to get a 20 character
              password
            </li>
            <li>
              <frenify_main>/joke</frenify_main> - I can cheer you up by telling
              a joke
            </li>
            <li>
              <frenify_main>/time</frenify_main> - display current time
            </li>
            <li>
              <frenify_main>/clear</frenify_main> - to clear current chat
            </li>
            <li>
              <frenify_main>/commands</frenify_main> - to list all available
              commands
            </li>
          </ul>
          <p>
            We are trying for you. We try to make unique themes and templates
            with excellent functionality and excellent design.
          </p>
        </>
      );
    }
            ...
            <div className="chat__list">
              ...
              <div className="chat__item active" id="chat1">
                ...
                {messages.map((message, index) => (
                  <div
                    className={`chat__box ${
                      message.author == "Bot" ? "bot__chat" : "your__chat"
                    }`}
                    key={index}
                  >
                    <div className="author">
                      <span>
                        {message.author} {console.log(message.author)}
                      </span>
                    </div>
                    <div className="chat">
                      <p>{message.text}</p>
