...
function FullscreenVideo(props) {
  ...
  return (
    <div className="w-full bg-gray-800 flex flex-row justify-stretch">
      <div
        id="main_video_content"
        className="relative w-[85%] h-[85vh] p-2 bg-transparent z-0"
      >
        <div
        ...
        <div
          ...
          class="video-btn absolute top-6 left-8 z-10 cursor-pointer rounded-lg bg-[#202128]"
        >
          <img src="/svg/close-rectangle.svg" />
        </div>

        <div
          id="detail_video_wrapper"
          className="w-full h-full flex flex-row  gap-2 z-10"
        >
          <div
            id="video_control_wrapper"
            className="relative w-[70%] flex flex-col justify-center overflow-hidden"
          >
            <div
              id="round_video_wrapper"
              title={`Video ${videoId}`}
          ...
          <div
            id="detail_video_content"
            className="w-[30%] h-full flex flex-col px-1 gap-3 mt-6 justify-between"
          >
            <div className="w-full flex flex-col items-center">
              ...
              >
                ...
                <button
                  ...
                  class="cursor-pointer video-btn flex items-center justify-center rounded-lg px-3 py-2 border  border-white/[0.08] hover:bg-slate-600"
                >
                  <svg
                    width="20"
                    height="20"
                  ...
                  <span class="ml-1 text-[14px] text-white">Copy</span>
                </button>
              </div>
            ...
            <div id="original_image_wrapper flex flex-col gap-3">
              ...
              <img
                src={videoInfo?.originalImage ?? mockOriginalImage}
                alt="Original image"
                width={"80"}
